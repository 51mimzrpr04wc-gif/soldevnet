...
def fetch_proxies():
    ...
    all_found = []
    # os.system('clear') dihapus karena di cloud sering bikin macet
        ...
        try:
            ...
            try:
                ...
                if resp.status_code == 200 and "result" in resp.json():
                    with print_lock:
                        stats["attempt"] += 1
                        # Perbaikan: Print ke bawah (normal) agar tidak macet/hang di Railway
                        print(f"[+] AIRDROP #{stats['attempt']} | Thread-{worker_id} OK")
                    ...
                    for _ in range(15): 
                        ...
                        try:
                            ...
                            if bal >= 1000000000:
                                ...
                                with print_lock:
                                    stats["success"] += 1
                                    print(f"    [✅] SUCCESS! TOTAL MASUK: {stats['success']} SOL")
                                break
                        except: continue
            except: pass
